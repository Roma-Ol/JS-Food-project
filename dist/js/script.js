...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const tabs = document.querySelectorAll(".tabheader__item"),
        ...
        tabsParent = document.querySelector(".tabheader__items"); // Hide all the unnecessary tabs.
  ...
  setClock(".timer", deadline); // MODAL WINDOWS WITH FORM
  // Getting the variables we'll use;

  let allButtons = document.querySelectorAll("[data-modal]"),
  ...
  } // Showing the form on every button click.
